...
CANAIS_BACKUP_DESTINO = [
    1392589268639289516,  # Canal 1 de backup
    1392589234610766045   # Canal 2 de backup
]

# Canal para backup de origem
CANAL_ORIGEM_ID = 1280314639867056160

# Canais que entrarão na enquete
CANAIS_ENQUETE = [
    1280314639867056163,
    1383199009245626448
]

# Nome do canal onde será enviada a enquete
NOME_CANAL_LIXEIRA = "lixeira"

# Cargo necessário para usar os comandos
...
# 🔐 Permissão restrita ao cargo "backuper"
...
# ⏰ Enquete e limpeza automática todo dia 9
@tasks.loop(hours=24)
async def tarefa_do_dia_9():
    ...
    for guild in bot.guilds:
        ...
        mensagem = await canal_lixeira.send(
            f"📊 **Qual canal deve ser apagado hoje (dia 9)?**\n\n" + "\n".join(canais_mencionados) +
...
# Token do seu bot
bot.run("MTM5MjU3Nzc1MDc0NDgzMDA1Mw.G2-Pdt.DZKPW6fXdCvTTuZfm-fHQv8Oihh1YqHnU9uVl4")
